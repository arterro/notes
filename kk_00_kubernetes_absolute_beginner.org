...
#+hugo_lastmod: Time-stamp: <2022-04-27 17:58:21 (adelgado)>
#+hugo_code_fence: nil
#+hugo_section: notes
#+hugo_draft: false
...
#+begin_src yaml :tangle run/replicaset-definition.yaml :eval no
...
#+begin_src sh :dir run :exports both :results code :eval no-export
...
#+begin_src sh :exports both :results code :eval no-export
...
#+begin_src yaml :tangle run/deployment-definition.yaml :eval no
...
#+begin_src sh :dir run :exports both :results output code :eval no-export
