...
#+hugo_lastmod: Time-stamp: <2022-04-29 13:00:15 (adelgado)>
#+hugo_code_fence: nil
#+hugo_section: notes
#+hugo_draft: false
...
+ Upgrading the application instances seamlessly, with an option to upgrade them one after the other instead of all at once which is known as a rolling update.
